...
Gui, Add, DDL, vBenchmark w160 section, Benchmark_Cards||Benchmark_Com|Benchmark_Dom|Benchmark_Fortress|Get250Cards|Gauntlet
...
ButtonSimulate:
Gui, Submit
execString = tuo.exe "Cyrus, Medic" "Mission #1" TBMD %Threads% %Iter% %GlobalLimit% %DeckSize% %CardLimitY% %ComLimitY% %DomLimitY% %IdLimit% %ReCalcIter% %MaxList% %OutList% %OutIdMax% %Benchmark%
